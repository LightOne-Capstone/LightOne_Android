...
class SuggestSectorHolderPage internal constructor(
    itemView: View,
    var d_itemClickListener: SuggestSectorAdapter.OnItemClickEventListener?,
    var scrapItemClickListener: SuggestSectorAdapter.OnItemClickEventListener?
    ...
    var data: SuggestDetailResponse? = null
    fun onBind(data: SuggestDetailResponse) {
        this.data = data
